...
var ApiManage = /*#__PURE__*/function () {
  _createClass(ApiManage, [{
    ...
    value: function mergeOptions(op) {
      ...
      var _ref = op,
          ...
          other = _objectWithoutProperties(_ref, ["request", "CancelToken"]);
  ...
  function ApiManage(options) {
    ...
    var _this$mergeOptions = this.mergeOptions(options),
        ...
        CancelToken = _this$mergeOptions.CancelToken,
        customize = _this$mergeOptions.customize,
        validate = _this$mergeOptions.validate; // 中断构造函数
    ...
    var methodAction = _objectSpread(_objectSpread({}, defaultMethodNames // .filter((type) => typeof request[type] === "function")
      ...
      return _objectSpread(_objectSpread({}, r), {}, _defineProperty({}, method, function (path, serveName) {
        return function (params) {
          ...
          var _ref2$tplData = _ref2.tplData,
              tplData = _ref2$tplData === void 0 ? {} : _ref2$tplData,
              _ref2$cancelParams = _ref2.cancelParams,
              cancelParams = _ref2$cancelParams === void 0 ? {} : _ref2$cancelParams,
              config = _objectWithoutProperties(_ref2, ["tplData", "cancelParams"]);

          var _cancelParams$isCalcF = cancelParams.isCalcFullPath,
              isCalcFullPath = _cancelParams$isCalcF === void 0 ? true : _cancelParams$isCalcF;
          ...
          if (CancelTokenFn) {
            requestToken = ApiManage.createCancelToken(requestParams, isCalcFullPath); // 中断 同一个 token
            ...
            config.cancelToken = new CancelTokenFn(function (cancleFn) {
    ...
    this.serveMap = Object.entries(apiList).reduce(function (result, _ref3) {
      ...
      Reflect.setPrototypeOf(serveFn, Object.create(_objectSpread(_objectSpread({
        resolve: function resolve() {
          ...
          if (method === "get") {
            ...
            query = typeof query === "string" ? protocol.replace("?", "") : query;
          }
        ...
        abort: function abort() {
          Object.entries(_this.cancelList).forEach(function (_ref7) {
  ...
  _createClass(ApiManage, [{
    ...
    value: function getService() {
      return Object.entries(this.serveMap).reduce(function (r, _ref9) {
...
_defineProperty(ApiManage, "bindApi", function (fns, params) {
  return (Array.isArray(fns) ? fns : [fns]).reduce(function (r, v) {
    ...
    return Object.entries(result).reduce(function (r2, _ref11) {
...
_defineProperty(ApiManage, "createCancelToken", function (requestParams) {
  var isCalcFullPath = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
...
_defineProperty(ApiManage, "flatApi", function (data) {
  return Object.entries(data).reduce(function (result, _ref14) {
    var _ref15 = _slicedToArray(_ref14, 2),
        method = _ref15[0],
        items = _ref15[1];

    return _objectSpread(_objectSpread({}, result), Object.entries(items).reduce(function (r, _ref16) {
