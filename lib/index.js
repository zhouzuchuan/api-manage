  ...
  var serviceList = Object.entries(list).reduce(function (r, _ref2) {
    ...
    return _objectSpread({}, r, Object.entries(apis).reduce(function (r2, _ref4) {
      ...
      if (customize[method]) {
        ...
        apiFun = function apiFun(params, _ref6) {
          var _ref6$tplData = _ref6.tplData,
              tplData = _ref6$tplData === void 0 ? {} : _ref6$tplData,
              config = _objectWithoutProperties(_ref6, ["tplData"]);

          return new Promise(function (resolve, reject) {
            request(_objectSpread({}, config, _defineProperty({
              method: method,
      ...
      Object.setPrototypeOf(apiFun, {
        resolve: function resolve() {
          ...
          var tplData = arguments.length > 1 ? arguments[1] : undefined;
          ...
          var _dealURI$_parts = dealURI._parts,
              ...
              path = _dealURI$_parts.path,
              port = _dealURI$_parts.port,
              protocol = _dealURI$_parts.protocol,
              query = _dealURI$_parts.query;

          var fn = (_apiFun = apiFun).bind.apply(_apiFun, [apiFun].concat(Array.prototype.slice.call(arguments)));
