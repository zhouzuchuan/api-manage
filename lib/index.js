...
var utils = {
  ...
  flatApi: function flatApi(data) {
    return Object.entries(data).reduce(function (result, _ref) {
      ...
      return _objectSpread({}, result, {}, Object.entries(items).reduce(function (r, _ref3) {
...
function () {
  _createClass(ApiManage, [{
    ...
    value: function createMethodService(otherCustomizeMethod, request) {
      var _this = this;
      ...
      var public2 = function public2(method, path, serveName) {
        return function (params) {
          ...
          var _ref5$tplData = _ref5.tplData,
              tplData = _ref5$tplData === void 0 ? {} : _ref5$tplData,
              config = _objectWithoutProperties(_ref5, ["tplData"]);
          ...
          var requestToken = _this.createCancelToken(requestParams);

          _this.abort(serveName)(requestToken); // removePending(requestData, true)


          config.cancelToken = new request.CancelToken(function (cancleFn) {
            Reflect.set(_this.cancelList, requestToken, [cancleFn, serveName]);
          });
          var _ref6 = _this.hooks,
              start = _ref6.start,
              resolve = _ref6.resolve,
              reject = _ref6.reject,
              hooksFinally = _ref6["finally"];
  ...
  function ApiManage(options) {
    ...
    this.hooks = hooks;
    this.createMethodService(options.customize, _axios["default"]);
    var apiList = utils.flatApi(list);
    this.serveMap = Object.entries(apiList).reduce(function (result, _ref7) {
      ...
      Object.setPrototypeOf(serveFn, {
        ...
        abort2: function abort2(serveName) {
          Object.values(_this2.cancelList).forEach(function (_ref9) {
            var _ref10 = _slicedToArray(_ref9, 2),
                cancelFn = _ref10[0],
                oldServeName = _ref10[1];
  ...
  _createClass(ApiManage, [{
    ...
    value: function getService() {
      return Object.entries(this.serveMap).reduce(function (r, _ref11) {
