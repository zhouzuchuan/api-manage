...
function () {
  ...
  function ApiManage(options) {
    ...
    this.serveMap = Object.entries(apiList).reduce(function (result, _ref6) {
      ...
      Object.setPrototypeOf(serveFn, {
        ...
        abort2: function abort2(serveName) {
          Object.values(_this2.cancelList).forEach(function (_ref8) {
            var _ref9 = _slicedToArray(_ref8, 2),
                cancelFn = _ref9[0],
                oldServeName = _ref9[1];
  ...
  _createClass(ApiManage, [{
    ...
    value: function getService() {
      return Object.entries(this.serveMap).reduce(function (r, _ref10) {
