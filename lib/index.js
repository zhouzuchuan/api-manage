...
exports["default"] = exports.createAbortCancel = exports.createAxiosCancel = exports.defineApi = void 0;
...
var createAxiosCancel = function createAxiosCancel(axios) {
  return function () {
    var cancel;
    var cancelToken = new axios.CancelToken(function (fn) {
      cancel = fn;
    });
    return {
      cancel: cancel,
...
exports.createAxiosCancel = createAxiosCancel;

var createAbortCancel = function createAbortCancel(AbortControllerClass) {
  return function () {
    var Controller = AbortControllerClass || globalThis.AbortController;

    if (!Controller) {
      throw new Error('api-manage: AbortController is not available, please pass a compatible constructor to createAbortCancel.');
    }
...
exports.createAbortCancel = createAbortCancel;

var ApiManage = /*#__PURE__*/function () {
  _createClass(ApiManage, null, [{
    key: "create",
    value: function create(options) {
      var createInstance = function createInstance(nextOptions) {
        return new ApiManage(nextOptions);
      };
  ...
  _createClass(ApiManage, [{
    ...
    value: function executeRequest(_ref8) {
      ...
      return Promise.resolve().then(function () {
        ...
        var response = res;
        return Promise.resolve(_this4.options.validate(response, typedServeName)).then(function (isValid) {
          ...
          return Promise.resolve((_this4$options$hooks$2 = (_this4$options$hooks2 = _this4.options.hooks).resolve) === null || _this4$options$hooks$2 === void 0 ? void 0 : _this4$options$hooks$2.call(_this4$options$hooks2, typedServeName, timestamp)).then(function () {
            return isLimit ? _this4.options.limitResponse(response, typedServeName) : response;
          });
        });
      }).then(function (value) {
