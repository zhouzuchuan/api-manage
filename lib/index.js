...
var ApiManage = /*#__PURE__*/function () {
  ...
  function ApiManage(options) {
    ...
    var methodAction = _objectSpread(_objectSpread({}, this.options.defaultMethodNames.reduce(function (r, method) {
      return _objectSpread(_objectSpread({}, r), {}, _defineProperty({}, method, function (path, serveName) {
        return _this.createServeFunction(path, method, serveName);
      }));
    ...
    this.serveMap = Object.entries(apiList).reduce(function (result, _ref) {
      ...
      var serveFn = methodAction[method](path, serveName);
  ...
  _createClass(ApiManage, [{
    ...
    value: function createServeFunction(path, method, serveName) {
      ...
      return function (params) {
        ...
        var _ref6$tplData = _ref6.tplData,
            tplData = _ref6$tplData === void 0 ? {} : _ref6$tplData,
            _ref6$cancelParams = _ref6.cancelParams,
            cancelParams = _ref6$cancelParams === void 0 ? {} : _ref6$cancelParams,
            _ref6$isLimit = _ref6.isLimit,
            isLimit = _ref6$isLimit === void 0 ? true : _ref6$isLimit,
            config = _objectWithoutProperties(_ref6, ["tplData", "cancelParams", "isLimit"]);
    ...
    value: function attachServeFunctionMethods(serveFn, path, method, serveName) {
      ...
      serveFn.abort = function () {
        Object.entries(_this3.cancelList).forEach(function (_ref7) {
          var _ref8 = _slicedToArray(_ref7, 2),
              cancelToken = _ref8[0],
              _ref8$ = _slicedToArray(_ref8[1], 2),
              cancelFn = _ref8$[0],
              oldServeName = _ref8$[1];
    ...
    key: "executeRequest",
    value: function executeRequest(_ref9) {
      var _this$options$methods,
          _cancelParams$open,
          _this4 = this;

      var method = _ref9.method,
          path = _ref9.path,
          serveName = _ref9.serveName,
          params = _ref9.params,
          _ref9$tplData = _ref9.tplData,
          tplData = _ref9$tplData === void 0 ? {} : _ref9$tplData,
          _ref9$cancelParams = _ref9.cancelParams,
          cancelParams = _ref9$cancelParams === void 0 ? {} : _ref9$cancelParams,
          _ref9$isLimit = _ref9.isLimit,
          isLimit = _ref9$isLimit === void 0 ? true : _ref9$isLimit,
          _ref9$config = _ref9.config,
          config = _ref9$config === void 0 ? {} : _ref9$config;
      var normalizedMethod = method || 'get';

      var requestParams = _defineProperty({
        method: normalizedMethod,
        url: ApiManage.template(path, tplData)
      }, (_this$options$methods = this.options.methodsForDataKeyNames[normalizedMethod]) !== null && _this$options$methods !== void 0 ? _this$options$methods : 'data', params);

      var requestToken = '';
      var timestamp = "".concat(Date.now());

      var requestConfig = _objectSpread({}, config);

      if (this.options.CancelRequest && ((_cancelParams$open = cancelParams === null || cancelParams === void 0 ? void 0 : cancelParams.open) !== null && _cancelParams$open !== void 0 ? _cancelParams$open : true)) {
        requestToken = ApiManage.createCancelToken(requestParams, cancelParams);
        ...
        try {
          requestConfig.cancelToken = new this.options.CancelRequest(function (cancelFn) {
            Reflect.set(_this4.cancelList, requestToken, [cancelFn, serveName]);
          });
        } catch (err) {
          console.error(err);
        }
      ...
      return Promise.resolve().then(function () {
        ...
        return (_this4$options$hooks$ = (_this4$options$hooks = _this4.options.hooks).start) === null || _this4$options$hooks$ === void 0 ? void 0 : _this4$options$hooks$.call(_this4$options$hooks, serveName, timestamp);
      }).then(function () {
        return _this4.options.request(_objectSpread(_objectSpread({}, requestConfig), requestParams));
      }).then(function (res) {
        return Promise.resolve(_this4.options.validate(res, serveName)).then(function (isValid) {
          ...
          return Promise.resolve((_this4$options$hooks$2 = (_this4$options$hooks2 = _this4.options.hooks).resolve) === null || _this4$options$hooks$2 === void 0 ? void 0 : _this4$options$hooks$2.call(_this4$options$hooks2, serveName, timestamp)).then(function () {
            return isLimit ? _this4.options.limitResponse(res, serveName) : res;
          });
        });
      }).then(function (value) {
        var _this4$options$hooks$3, _this4$options$hooks3;

        return Promise.resolve((_this4$options$hooks$3 = (_this4$options$hooks3 = _this4.options.hooks)["finally"]) === null || _this4$options$hooks$3 === void 0 ? void 0 : _this4$options$hooks$3.call(_this4$options$hooks3, serveName, timestamp)).then(function () {
          return value;
        });
      }, function (error) {
        var _this4$options$hooks$4, _this4$options$hooks4;

        return Promise.resolve((_this4$options$hooks$4 = (_this4$options$hooks4 = _this4.options.hooks).reject) === null || _this4$options$hooks$4 === void 0 ? void 0 : _this4$options$hooks$4.call(_this4$options$hooks4, serveName, timestamp, error))["catch"](function () {
          return undefined;
        }).then(function () {
          var _this4$options$hooks$5, _this4$options$hooks5;

          return Promise.resolve((_this4$options$hooks$5 = (_this4$options$hooks5 = _this4.options.hooks)["finally"]) === null || _this4$options$hooks$5 === void 0 ? void 0 : _this4$options$hooks$5.call(_this4$options$hooks5, serveName, timestamp));
        })["catch"](function () {
          return undefined;
        }).then(function () {
          throw error;
...
_defineProperty(ApiManage, "bindApi", function (fns, params) {
  return (Array.isArray(fns) ? fns : [fns]).reduce(function (r, v) {
    ...
    return Object.entries(result).reduce(function (r2, _ref10) {
...
_defineProperty(ApiManage, "createCancelToken", function (requestParams) {
  ...
  return isCalcFullPath ? encodeURIComponent(url + JSON.stringify(method === 'get' ? {
...
_defineProperty(ApiManage, "flatApi", function (data) {
  return Object.entries(data).reduce(function (result, _ref13) {
    var _ref14 = _slicedToArray(_ref13, 2),
        method = _ref14[0],
        items = _ref14[1];

    return _objectSpread(_objectSpread({}, result), Object.entries(items).reduce(function (r, _ref15) {
